...
CREATE TABLE `mat`  (
  `mat_id` int NOT NULL AUTO_INCREMENT COMMENT '结伴游帖子id',
...
CREATE TABLE `mat_reply`  (
  `reply_id` int NOT NULL AUTO_INCREMENT COMMENT '申请id',
  `mat_id` int NULL DEFAULT NULL COMMENT '结伴游id',
  ...
  `status` int NULL DEFAULT NULL COMMENT '0未处理，1通过，2拒绝',
...
CREATE TABLE `tourim_strategy`  (
  `strategy_id` int NOT NULL AUTO_INCREMENT COMMENT '攻略id',
  ...
  `is_show` int NULL DEFAULT NULL COMMENT '0隐藏，1显示',
  `city` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '旅游城市',
  `strategy_likes` int NULL DEFAULT NULL COMMENT '喜欢数',
  `strategy_collections` int NULL DEFAULT NULL COMMENT '收藏数',
  `strategy_shares` int NULL DEFAULT NULL COMMENT '分享数',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
...
CREATE TABLE `tourim_strategy_appraise`  (
  `appraise_id` int NOT NULL COMMENT '攻略评价id',
  `user_id` int NULL DEFAULT NULL COMMENT '用户id',
  `strategy_id` int NULL DEFAULT NULL COMMENT '攻略id',
...
CREATE TABLE `user`  (
  ...
  `telephone` int NULL DEFAULT NULL COMMENT '电话号码',
  `description` int NULL DEFAULT NULL COMMENT '签名',
