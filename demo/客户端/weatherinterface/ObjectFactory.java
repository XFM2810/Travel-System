 ...
 * generated in the weatherinterface package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("WeatherInterface", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("WeatherInterface", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: weatherinterface
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "WeatherInterface", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "WeatherInterface", name = "queryWeatherResponse")
