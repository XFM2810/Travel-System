// pages/lvtudetail/lvtudetail.js
...
Page({  
 ...
 wx.request({ //评论部分
      ...
      url: app.globalData.url+'commitReply',  
      data:{
          replyContent:e.detail.value.pinglun,
          matId:that.data.Tid,
  ...
  onLoad: function (options) {
    this.setData({
      Tid:options.id   //matId
    })
 
  var that = this
  wx.request({ 
        
    url: app.globalData.url+'getMatchInfo?matId='+options.id,  //相应帖子页面
    data:{
